let handler = async (m, { conn }) => {
  let datos = [
    ...
    'Te dice "te amo" pero también se lo dice a otros tres más',
    'No es que no quiera una relación, es que no la quiere contigo',
    'Si te busca solo cuando está mal, eres su psicólogo gratis',
    ...
    'Eres el bueno, pero no el suficiente',
    'No estabas compitiendo, pero perdiste igual',
    ...
    'Si te busca solo en sus vacíos, eres relleno emocional',
