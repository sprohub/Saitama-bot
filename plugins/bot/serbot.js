...
// Portado del sistema de subbots de ALEPANDA-BOT.
import { leerStatus, contarSubbotsDe, crearSubbotCompleto } from '../../lib/subbots.js';
...
const handler = async (m, { conn, args, usedPrefix }) => {
  ...
  if (!numero) {
    return conn.sendMessage(m.chat, {
      text: `Uso: ${usedPrefix}serbot <numero con codigo de pais, sin +>\nEj: ${usedPrefix}serbot 5215512345678\n\nEse numero se convertira en tu propio subbot, con su propio proceso, aislado del bot principal.`
    }, { quoted: m });
  }
